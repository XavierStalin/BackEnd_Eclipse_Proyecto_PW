...
a persistence unit "portafolioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "portafolio/pom.xml":
...
artifact ("portafolio.war") is already built. You can build
